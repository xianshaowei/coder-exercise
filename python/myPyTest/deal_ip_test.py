...
def deal_ip_list(ip_string):
    """ 处理形如 10.204.80.11-15,10.204.80.17 """
...
if __name__ == '__main__':
    # ip_string = "10.204.80.11-15,10.204.80.17,10.204.80.100-115"
    # #deal_ip_list(ip_string)
    #
    # ip_string2 = "10.0.80.1-155"
    # deal_continue_ip_list(ip_string2)
    #
    # print deal_continue_ip_list(ip_string2)

    #child = subprocess.Popen(["pwd"], stdout=subprocess.PIPE)
    ...
    print re.match('www', 'wwww.runoob.com')
    print re.match('run', 'wwww.runoob.com')
    print re.search('run', 'wwww.runoob.com')
